namespace Scp035
{
    ...
    public class Scp035Item : CustomItem
    {
        ...
        private void AddMask(Player player)
        {
            // هنا يمكنك إضافة الكود الخاص بإضافة القناع إلى اللاعب.
            // هذا هو جزء من الكود حيث يمكنك تغيير مظهر اللاعب ليشمل القناع.
            // على سبيل المثال:
            player.EnableEffect(EffectType.AntiScp207, 30f); // إظهار تأثير القناع لمدة 30 ثانية
        }
